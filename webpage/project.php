...
// ---- 向后台请求左侧导航栏列表 ---- //
//$ch = curl_init("http://localhost/hw/get_project.php"); // fake data
...
// ---- 向后台请求具体项目信息 ---- //
//$ch = curl_init("http://localhost/hw/get_project.php?sid=" . $sid); // fake data
$ch = curl_init($server_base_backend . "get_project?sid=" . $sid); // fetch data from server
curl_setopt($ch, CURLOPT_CUSTOMREQUEST, "GET");
curl_setopt($ch, CURLOPT_HEADER, 0);
curl_setopt($ch, CURLOPT_RETURNTRANSFER, 1);
$res = curl_exec($ch);
		      	...
		      	<div class="col-md-10 col-md-offset-1">
			        <nav class="blog-nav" >
			          <a class="blog-nav-item" href="index.html">首页</a>
                          <a class="blog-nav-item active" href="project.php">关于项目</a>
                    ...
                    <div class="container">
                        ...
                        <div class="col-sm-4">
                            ...
                            <div class="project_sub">
                                ...
                                <?php
                                  if (!isset($pro_info) || $pro_info->progress == "") {
                                    ...
                                    echo $pro_info->progress;
                                  }
                                ?>
                                <a href="http://localhost/hw/progress.php?sid=<?php echo $sid; ?>">详细情况</a></p>
                            </div>
                            ...
                            <div class="project_sub">
                                ...
                                <p><a href="http://localhost/hw/db?sid=<? echo $sid ?>">点击查看</a></p>
                            </div>
