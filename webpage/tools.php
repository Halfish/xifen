...
// ---- 向后台请求具体信息 ---- //
$u = "get_tools.php?sid=" + $sid;

$ch = curl_init("http://172.18.217.250:5000/get_tools?sid=" . $sid);
...
<html lang="zh-CN">
  <head>
    ...
    <link rel='icon' href='pics/logo.jpg' type='image/x-ico' />
		...
		<link href="custom_css/tools.css" rel="stylesheet">
  </head>
		      ...
		      <div class="row">
		      	<div class="col-md-10 col-md-offset-1">
			        <nav class="blog-nav" >
			          ...
			          <a class="blog-nav-item active" href="tools.php">数据/工具</a>
			        </nav>
			    	</div>
			    </div>
		    </div>
    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-sm-3" style="font-size:20px">
                <div class="sidenav">
                    <ul>
                        <li><a class="blog-nav-item" href="localhost:80/hw/tools.php?sid=1">团队数据共享</a></li>
                        <li><a class="blog-nav-item" href="localhost:80/hw/tools.php?sid=2">站外数据库</a></li>
                        <li><a class="blog-nav-item" href="localhost:80/hw/tools.php?sid=3">常用分析工具</a></li>
                    </ul>
                </div>
            </div>
                    ...
                    <div class="container">
                        <div class="col-sm-9">
                            ...
                            <div class="tools">
                                <p>
                                <?php
                                  if (!isset($pro_info) || $pro_info->tools_link == "") {
                                    echo '<span style="color:#222">暂无信息</span>';
                                  } else {
                                    echo '<ul>';
                                    $alist = $pro_info->tools_link;
