      ...
      <div class="row">
        ...
        <div class="col-sm-9">
          <div style="padding:10px 30px; border: solid #ccc 1px; margin-bottom:50px;">
            ...
            <h3 style="text-align:center">项目管理</h3>
              ...
              if (isset($nav_list) or count($nav_list) == 0) {
                foreach ($nav_list as $line) {
                  ...
                  foreach ($splist as $spline) {
                    ...
                    echo "<td>$spname</td>";
                    echo '<td><a href="edit_project.php?sid=' . $tsid . '">编辑</a>&nbsp;&nbsp;';
                    echo '<a href="edit_progress.php?sid=' . $tsid . '">项目进展</td></tr>';
                  }
                }
              }
              ?>
            ...
            <p><a href="edit_project.php"><u>点击新建</u></a></p>
          </div>
        </div>
      </div>
    </div>
